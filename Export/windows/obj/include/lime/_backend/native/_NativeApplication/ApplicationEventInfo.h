...
HX_DECLARE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_746_new)
...
HXLINE( 748)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->type = type;
HXLINE( 749)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
