...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_809_new)
...
HXLINE( 811)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 812)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
