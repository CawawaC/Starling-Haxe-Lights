...
HX_DECLARE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_1088_new)
...
HXLINE(1090)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->type = type;
HXLINE(1091)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->windowID = windowID;
HXLINE(1092)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->text = text;
HXLINE(1093)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->start = start;
HXLINE(1094)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->length = length;
            	}
