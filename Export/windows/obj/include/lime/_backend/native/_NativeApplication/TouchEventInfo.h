...
HX_DECLARE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1130_new)
...
HXLINE(1132)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->type = type;
HXLINE(1133)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->x = x;
HXLINE(1134)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->y = y;
HXLINE(1135)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->id = id;
HXLINE(1136)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1137)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1138)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1139)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->device = device;
            	}
