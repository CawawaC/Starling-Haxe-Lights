...
HX_DECLARE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1174_new)
...
HXLINE(1176)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->type = type;
HXLINE(1177)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1178)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->width = width;
HXLINE(1179)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->height = height;
HXLINE(1180)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->x = x;
HXLINE(1181)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->y = y;
            	}
