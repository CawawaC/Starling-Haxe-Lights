...
HXLINE(  45)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->activeTextures = (int)0;
HXLINE(  61)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->allowSmoothing = true;
HXLINE(  62)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->clearRenderDirty = false;
            	}
