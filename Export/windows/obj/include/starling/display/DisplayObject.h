...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::starling::events::EventDispatcher_obj
{
	...
	public:
		...
		virtual void _hx___updateTransformationMatrices(Float x,Float y,Float pivotX,Float pivotY,Float scaleX,Float scaleY,Float skewX,Float skewY,Float rotation, ::openfl::geom::Matrix out, ::openfl::geom::Matrix3D out3D);
		...
		virtual  ::openfl::geom::Matrix set_transformationMatrix( ::openfl::geom::Matrix matrix);
