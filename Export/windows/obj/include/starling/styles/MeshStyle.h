...
class HXCPP_CLASS_ATTRIBUTES MeshStyle_obj : public  ::starling::events::EventDispatcher_obj
{
	...
	public:
		...
		virtual void copyFrom( ::starling::styles::MeshStyle meshStyle);
		::Dynamic copyFrom_dyn();

		 ::starling::styles::MeshStyle clone();
		::Dynamic clone_dyn();

		virtual  ::starling::rendering::MeshEffect createEffect();
		::Dynamic createEffect_dyn();

		virtual void updateEffect( ::starling::rendering::MeshEffect effect, ::starling::rendering::RenderState state);
		::Dynamic updateEffect_dyn();

		virtual bool canBatchWith( ::starling::styles::MeshStyle meshStyle);
		::Dynamic canBatchWith_dyn();

		virtual void batchVertexData( ::starling::styles::MeshStyle targetStyle,hx::Null< int >  targetVertexID, ::openfl::geom::Matrix matrix,hx::Null< int >  vertexID,hx::Null< int >  numVertices);
		...
		virtual void onTargetAssigned( ::starling::display::Mesh target);
		...
		virtual void setTexCoords(int vertexID,Float u,Float v);
