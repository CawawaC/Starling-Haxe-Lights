...
HXLINE(  23)		::String projectName = HX_("::file::",fc,5a,74,e6);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("::company::",7d,46,0a,c3))
            			...
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(9,HX_("height",e7,07,4c,02),(int)600)
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("::title::",98,83,7d,a5))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("::packageName::",31,2b,f4,29))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("::file::",fc,5a,74,e6))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("::title::",98,83,7d,a5))
            			->setFixed(8,HX_("version",18,e7,f1,7c),HX_("::version::",18,85,cf,cd)));
