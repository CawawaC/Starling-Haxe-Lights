...
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_403_handleMouseEvent,"lime._backend.native.NativeApplication","handleMouseEvent",0xe26e46c9,"lime._backend.native.NativeApplication.handleMouseEvent","lime/_backend/native/NativeApplication.hx",403,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_439_handleRenderEvent,"lime._backend.native.NativeApplication","handleRenderEvent",0xf3931b50,"lime._backend.native.NativeApplication.handleRenderEvent","lime/_backend/native/NativeApplication.hx",439,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_506_handleSensorEvent,"lime._backend.native.NativeApplication","handleSensorEvent",0x6e3cd9ec,"lime._backend.native.NativeApplication.handleSensorEvent","lime/_backend/native/NativeApplication.hx",506,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_519_handleTextEvent,"lime._backend.native.NativeApplication","handleTextEvent",0x373acb99,"lime._backend.native.NativeApplication.handleTextEvent","lime/_backend/native/NativeApplication.hx",519,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_546_handleTouchEvent,"lime._backend.native.NativeApplication","handleTouchEvent",0xbe3236ef,"lime._backend.native.NativeApplication.handleTouchEvent","lime/_backend/native/NativeApplication.hx",546,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_614_handleWindowEvent,"lime._backend.native.NativeApplication","handleWindowEvent",0x18b48476,"lime._backend.native.NativeApplication.handleWindowEvent","lime/_backend/native/NativeApplication.hx",614,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_684_setFrameRate,"lime._backend.native.NativeApplication","setFrameRate",0xfc951cf7,"lime._backend.native.NativeApplication.setFrameRate","lime/_backend/native/NativeApplication.hx",684,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_697_updateTimer,"lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",697,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_726_updateTimer,"lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",726,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void NativeApplication_obj::handleMouseEvent(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_403_handleMouseEvent)
HXLINE( 405)		 ::lime::ui::Window window = this->parent->windowByID->get(this->mouseEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 407)		if (hx::IsNotNull( window )) {
HXLINE( 409)			int _g = this->mouseEventInfo->type;
HXDLIN( 409)			switch((int)(_g)){
            				case (int)0: {
HXLINE( 413)					window->onMouseDown->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
            				}
            				break;
            				case (int)1: {
HXLINE( 417)					window->onMouseUp->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
            				}
            				break;
            				case (int)2: {
HXLINE( 421)					window->onMouseMove->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y);
HXLINE( 422)					window->onMouseMoveRelative->dispatch(this->mouseEventInfo->movementX,this->mouseEventInfo->movementY);
            				}
            				break;
            				case (int)3: {
HXLINE( 426)					window->onMouseWheel->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y);
            				}
            				break;
            				default:{
            				}
...
void NativeApplication_obj::handleRenderEvent(){
            	HX_GC_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_439_handleRenderEvent)
HXDLIN( 439)		int _g = (int)0;
HXDLIN( 439)		::Array< ::Dynamic> _g1 = this->parent->_hx___renderers;
HXDLIN( 439)		while((_g < _g1->length)){
HXDLIN( 439)			 ::lime::graphics::Renderer renderer = _g1->__get(_g).StaticCast<  ::lime::graphics::Renderer >();
HXDLIN( 439)			_g = (_g + (int)1);
HXLINE( 441)			if (hx::IsNull( renderer )) {
HXLINE( 441)				continue;
            			}
HXLINE( 443)			this->parent->renderer = renderer;
HXLINE( 445)			{
HXLINE( 445)				int _g2 = this->renderEventInfo->type;
HXDLIN( 445)				switch((int)(_g2)){
            					case (int)0: {
HXLINE( 449)						if (hx::IsNotNull( renderer->context )) {
HXLINE( 451)							renderer->render();
HXLINE( 452)							renderer->onRender->dispatch();
HXLINE( 454)							if (!(renderer->onRender->canceled)) {
HXLINE( 456)								renderer->flip();
            							}
            						}
            					}
            					break;
...
HXDLIN( 464)						if (renderer->backend->useHardware) {
HXLINE( 464)							_hx_tmp = hx::IsNotNull( renderer->context );
            						}
            						else {
...
HXLINE( 466)							{
HXLINE( 466)								 ::lime::graphics::RenderContext _g21 = renderer->context;
HXDLIN( 466)								if ((_hx_getEnumValueIndex(_g21) == (int)0)) {
HXLINE( 468)									 ::lime::_backend::native::NativeGLRenderContext gl = _g21->_hx_getObject(0).StaticCast<  ::lime::_backend::native::NativeGLRenderContext >();
HXDLIN( 468)									{
HXLINE( 471)										gl->_hx___contextLost();
HXLINE( 472)										if (hx::IsEq( ::lime::graphics::opengl::GL_obj::context,gl )) {
HXLINE( 472)											::lime::graphics::opengl::GL_obj::context = null();
            										}
            									}
            								}
            							}
HXLINE( 479)							renderer->context = null();
HXLINE( 480)							renderer->onContextLost->dispatch();
            						}
            					}
            					break;
            					case (int)2: {
HXLINE( 486)						if (renderer->backend->useHardware) {
HXLINE( 491)							::lime::graphics::opengl::GL_obj::context =  ::lime::_backend::native::NativeGLRenderContext_obj::__alloc( HX_CTX );
HXLINE( 492)							renderer->context = ::lime::graphics::RenderContext_obj::OPENGL(::lime::graphics::opengl::GL_obj::context);
HXLINE( 495)							renderer->onContextRestored->dispatch(renderer->context);
            						}
            					}
            					break;
            				}
...
void NativeApplication_obj::handleSensorEvent(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_506_handleSensorEvent)
HXLINE( 508)		 ::lime::_hx_system::Sensor sensor = ::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id).StaticCast<  ::lime::_hx_system::Sensor >();
HXLINE( 510)		if (hx::IsNotNull( sensor )) {
HXLINE( 512)			sensor->onUpdate->dispatch(this->sensorEventInfo->x,this->sensorEventInfo->y,this->sensorEventInfo->z);
            		}
            	}
...
void NativeApplication_obj::handleTextEvent(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_519_handleTextEvent)
HXLINE( 521)		 ::lime::ui::Window window = this->parent->windowByID->get(this->textEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 523)		if (hx::IsNotNull( window )) {
HXLINE( 525)			int _g = this->textEventInfo->type;
HXDLIN( 525)			switch((int)(_g)){
            				case (int)0: {
HXLINE( 529)					window->onTextInput->dispatch(this->textEventInfo->text);
            				}
            				break;
            				case (int)1: {
HXLINE( 533)					window->onTextEdit->dispatch(this->textEventInfo->text,this->textEventInfo->start,this->textEventInfo->length);
            				}
            				break;
            				default:{
            				}
...
void NativeApplication_obj::handleTouchEvent(){
            	HX_GC_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_546_handleTouchEvent)
HXDLIN( 546)		int _g = this->touchEventInfo->type;
HXDLIN( 546)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 550)				 ::lime::ui::Touch touch = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
HXLINE( 552)				if (hx::IsNull( touch )) {
HXLINE( 554)					touch =  ::lime::ui::Touch_obj::__alloc( HX_CTX ,this->touchEventInfo->x,this->touchEventInfo->y,this->touchEventInfo->id,this->touchEventInfo->dx,this->touchEventInfo->dy,this->touchEventInfo->pressure,this->touchEventInfo->device);
            				}
            				else {
HXLINE( 558)					touch->x = this->touchEventInfo->x;
HXLINE( 559)					touch->y = this->touchEventInfo->y;
HXLINE( 560)					touch->id = this->touchEventInfo->id;
HXLINE( 561)					touch->dx = this->touchEventInfo->dx;
HXLINE( 562)					touch->dy = this->touchEventInfo->dy;
HXLINE( 563)					touch->pressure = this->touchEventInfo->pressure;
HXLINE( 564)					touch->device = this->touchEventInfo->device;
            				}
HXLINE( 568)				::haxe::IMap_obj::set(this->currentTouches,touch->id,touch);
HXLINE( 570)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			}
            			break;
            			case (int)1: {
HXLINE( 574)				 ::lime::ui::Touch touch1 = ( ( ::lime::ui::Touch)(::haxe::IMap_obj::get(this->currentTouches,this->touchEventInfo->id)) );
HXLINE( 576)				if (hx::IsNotNull( touch1 )) {
HXLINE( 578)					touch1->x = this->touchEventInfo->x;
HXLINE( 579)					touch1->y = this->touchEventInfo->y;
HXLINE( 580)					touch1->dx = this->touchEventInfo->dx;
HXLINE( 581)					touch1->dy = this->touchEventInfo->dy;
HXLINE( 582)					touch1->pressure = this->touchEventInfo->pressure;
HXLINE( 584)					::lime::ui::Touch_obj::onEnd->dispatch(touch1);
HXLINE( 586)					::haxe::IMap_obj::remove(this->currentTouches,this->touchEventInfo->id);
HXLINE( 587)					this->unusedTouchesPool->add(touch1);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 593)				 ::lime::ui::Touch touch2 = ( ( ::lime::ui::Touch)(::haxe::IMap_obj::get(this->currentTouches,this->touchEventInfo->id)) );
HXLINE( 595)				if (hx::IsNotNull( touch2 )) {
HXLINE( 597)					touch2->x = this->touchEventInfo->x;
HXLINE( 598)					touch2->y = this->touchEventInfo->y;
HXLINE( 599)					touch2->dx = this->touchEventInfo->dx;
HXLINE( 600)					touch2->dy = this->touchEventInfo->dy;
HXLINE( 601)					touch2->pressure = this->touchEventInfo->pressure;
HXLINE( 603)					::lime::ui::Touch_obj::onMove->dispatch(touch2);
            				}
            			}
            			break;
            			default:{
...
void NativeApplication_obj::handleWindowEvent(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_614_handleWindowEvent)
HXLINE( 616)		 ::lime::ui::Window window = this->parent->windowByID->get(this->windowEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 618)		if (hx::IsNotNull( window )) {
HXLINE( 620)			int _g = this->windowEventInfo->type;
HXDLIN( 620)			switch((int)(_g)){
            				case (int)0: {
HXLINE( 624)					window->onActivate->dispatch();
HXLINE( 626)					::lime::media::AudioManager_obj::resume();
            				}
            				break;
            				case (int)1: {
HXLINE( 630)					window->close();
            				}
            				break;
            				case (int)2: {
HXLINE( 634)					window->onDeactivate->dispatch();
HXLINE( 636)					::lime::media::AudioManager_obj::suspend();
            				}
            				break;
            				case (int)3: {
HXLINE( 640)					window->onEnter->dispatch();
            				}
            				break;
            				case (int)4: {
HXLINE( 644)					window->onFocusIn->dispatch();
            				}
            				break;
            				case (int)5: {
HXLINE( 648)					window->onFocusOut->dispatch();
            				}
            				break;
            				case (int)6: {
HXLINE( 652)					window->onLeave->dispatch();
            				}
            				break;
            				case (int)7: {
HXLINE( 656)					window->_hx___minimized = true;
HXLINE( 657)					window->onMinimize->dispatch();
            				}
            				break;
            				case (int)8: {
HXLINE( 661)					window->_hx___x = this->windowEventInfo->x;
HXLINE( 662)					window->_hx___y = this->windowEventInfo->y;
HXLINE( 663)					window->onMove->dispatch(this->windowEventInfo->x,this->windowEventInfo->y);
            				}
            				break;
            				case (int)9: {
HXLINE( 667)					window->_hx___width = this->windowEventInfo->width;
HXLINE( 668)					window->_hx___height = this->windowEventInfo->height;
HXLINE( 669)					window->onResize->dispatch(this->windowEventInfo->width,this->windowEventInfo->height);
            				}
            				break;
            				case (int)10: {
HXLINE( 673)					window->_hx___fullscreen = false;
HXLINE( 674)					window->_hx___minimized = false;
HXLINE( 675)					window->onRestore->dispatch();
            				}
            				break;
            			}
            		}
...
Float NativeApplication_obj::setFrameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_684_setFrameRate)
HXLINE( 687)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_application_set_frame_rate(hx::DynamicPtr(this->handle),value);
HXLINE( 689)		return (this->frameRate = value);
            	}
...
void NativeApplication_obj::updateTimer(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_697_updateTimer)
...
HXLINE( 709)						if ((currentTime >= timer->mFireAt)) {
...
HXLINE( 724)			if (foundNull) {
            				...
            				bool _hx_run( ::haxe::Timer val){
            					HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_726_updateTimer)
