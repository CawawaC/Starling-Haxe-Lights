...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_844_new,"lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",844,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_3b7a66bddb205621_857_clone,"lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",857,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3b7a66bddb205621_857_clone)
HXDLIN( 857)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->value);
            	}
