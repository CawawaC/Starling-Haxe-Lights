...
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_972_new,"lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",972,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_e3566ee739d748b6_987_clone,"lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",987,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e3566ee739d748b6_987_clone)
HXDLIN( 987)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
