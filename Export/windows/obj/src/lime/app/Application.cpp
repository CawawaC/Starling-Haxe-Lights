...
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_117_addModule,"lime.app.Application","addModule",0x673258c9,"lime.app.Application.addModule","lime/app/Application.hx",117,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_152_addRenderer,"lime.app.Application","addRenderer",0x0a61eaa0,"lime.app.Application.addRenderer","lime/app/Application.hx",152,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_171_create,"lime.app.Application","create",0x35e42e60,"lime.app.Application.create","lime/app/Application.hx",171,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_222_createWindow,"lime.app.Application","createWindow",0xb3683e70,"lime.app.Application.createWindow","lime/app/Application.hx",222,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_254_exec,"lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",254,0x8bc55476)
...
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_272_onWindowClose,"lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",272,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_283_removeModule,"lime.app.Application","removeModule",0x6e873a74,"lime.app.Application.removeModule","lime/app/Application.hx",283,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_295_removeWindow,"lime.app.Application","removeWindow",0x004099b8,"lime.app.Application.removeWindow","lime/app/Application.hx",295,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_324_setPreloader,"lime.app.Application","setPreloader",0xe5520ed8,"lime.app.Application.setPreloader","lime/app/Application.hx",324,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_346_get_frameRate,"lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",346,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_353_set_frameRate,"lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",353,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_360_get_preloader,"lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",360,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_367_get_renderer,"lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",367,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_374_get_renderers,"lime.app.Application","get_renderers",0x05eb56c3,"lime.app.Application.get_renderers","lime/app/Application.hx",374,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_381_get_window,"lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",381,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_388_get_windows,"lime.app.Application","get_windows",0x94992cb6,"lime.app.Application.get_windows","lime/app/Application.hx",388,0x8bc55476)
namespace lime{
namespace app{
...
HXLINE(  97)		if (hx::IsNull( ::lime::app::Application_obj::current )) {
HXLINE(  99)			::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 103)		this->modules = ::Array_obj< ::Dynamic>::__new();
HXLINE( 104)		this->windowByID =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 106)		this->backend =  ::lime::_backend::native::NativeApplication_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
HXLINE( 108)		this->registerModule(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Application_obj::addModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_117_addModule)
HXLINE( 119)		::lime::app::IModule_obj::registerModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE( 120)		this->modules->push(module);
HXLINE( 122)		if ((this->_hx___renderers->length > (int)0)) {
HXLINE( 124)			int _g = (int)0;
HXDLIN( 124)			::Array< ::Dynamic> _g1 = this->_hx___renderers;
HXDLIN( 124)			while((_g < _g1->length)){
HXLINE( 124)				 ::lime::graphics::Renderer renderer = _g1->__get(_g).StaticCast<  ::lime::graphics::Renderer >();
HXDLIN( 124)				_g = (_g + (int)1);
HXLINE( 126)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
HXLINE( 132)		if ((this->_hx___windows->length > (int)0)) {
HXLINE( 134)			int _g2 = (int)0;
HXDLIN( 134)			::Array< ::Dynamic> _g11 = this->_hx___windows;
HXDLIN( 134)			while((_g2 < _g11->length)){
HXLINE( 134)				 ::lime::ui::Window window = _g11->__get(_g2).StaticCast<  ::lime::ui::Window >();
HXDLIN( 134)				_g2 = (_g2 + (int)1);
HXLINE( 136)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 142)		::lime::app::IModule_obj::setPreloader(module,this->_hx___preloader);
            	}
...
void Application_obj::addRenderer( ::lime::graphics::Renderer renderer){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_152_addRenderer)
HXLINE( 154)		this->super::addRenderer(renderer);
HXLINE( 156)		{
HXLINE( 156)			int _g = (int)0;
HXDLIN( 156)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 156)			while((_g < _g1->length)){
HXLINE( 156)				::Dynamic module = _g1->__get(_g);
HXDLIN( 156)				_g = (_g + (int)1);
HXLINE( 158)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
            	}
...
void Application_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_171_create)
HXLINE( 173)		this->config = config;
HXLINE( 175)		this->backend->create(config);
HXLINE( 177)		if (hx::IsNotNull( config )) {
HXLINE( 179)			if (::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00))) {
HXLINE( 181)				this->backend->setFrameRate(( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) ));
            			}
HXLINE( 185)			if (::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8))) {
HXLINE( 187)				int _g = (int)0;
HXDLIN( 187)				::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN( 187)				while((_g < _g1->length)){
HXLINE( 187)					 ::Dynamic windowConfig = _g1->__get(_g);
HXDLIN( 187)					_g = (_g + (int)1);
HXLINE( 189)					 ::lime::ui::Window window =  ::lime::ui::Window_obj::__alloc( HX_CTX ,windowConfig);
HXLINE( 190)					this->createWindow(window);
            				}
            			}
HXLINE( 200)			bool _hx_tmp;
HXDLIN( 200)			if (hx::IsNotNull( this->_hx___preloader )) {
HXLINE( 200)				_hx_tmp = this->_hx___preloader->complete;
            			}
            			else {
HXLINE( 200)				_hx_tmp = true;
            			}
HXDLIN( 200)			if (_hx_tmp) {
HXLINE( 202)				this->setPreloader(this->_hx___preloader);
HXLINE( 204)				{
HXLINE( 204)					int _g2 = (int)0;
HXDLIN( 204)					::Array< ::Dynamic> _g11 = this->modules;
HXDLIN( 204)					while((_g2 < _g11->length)){
HXLINE( 204)						::Dynamic module = _g11->__get(_g2);
HXDLIN( 204)						_g2 = (_g2 + (int)1);
HXLINE( 206)						this->setPreloader(this->_hx___preloader);
            					}
            				}
            			}
            		}
...
void Application_obj::createWindow( ::lime::ui::Window window){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_222_createWindow)
HXLINE( 224)		this->super::addWindow(window);
HXLINE( 226)		{
HXLINE( 226)			int _g = (int)0;
HXDLIN( 226)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 226)			while((_g < _g1->length)){
HXLINE( 226)				::Dynamic module = _g1->__get(_g);
HXDLIN( 226)				_g = (_g + (int)1);
HXLINE( 228)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 232)		if (hx::IsNull( window->renderer )) {
HXLINE( 234)			 ::lime::graphics::Renderer renderer =  ::lime::graphics::Renderer_obj::__alloc( HX_CTX ,window);
HXLINE( 235)			this->addRenderer(renderer);
            		}
HXLINE( 239)		window->create(hx::ObjectPtr<OBJ_>(this));
HXLINE( 241)		this->windowByID->set(window->id,window);
HXLINE( 243)		window->onCreate->dispatch();
            	}
...
int Application_obj::exec(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_254_exec)
HXLINE( 256)		::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
HXLINE( 258)		return this->backend->exec();
            	}
...
HXDLIN( 265)		this->backend->exit();
            	}


void Application_obj::onWindowClose( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_272_onWindowClose)
HXDLIN( 272)		this->removeWindow(window);
            	}


void Application_obj::removeModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_283_removeModule)
HXDLIN( 283)		if (hx::IsNotNull( module )) {
HXLINE( 285)			::lime::app::IModule_obj::unregisterModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE( 286)			this->modules->remove(module);
            		}
            	}
...
void Application_obj::removeWindow( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_295_removeWindow)
HXDLIN( 295)		bool _hx_tmp;
HXDLIN( 295)		if (hx::IsNotNull( window )) {
HXDLIN( 295)			_hx_tmp = this->windowByID->exists(window->id);
            		}
            		else {
HXDLIN( 295)			_hx_tmp = false;
            		}
HXDLIN( 295)		if (_hx_tmp) {
HXLINE( 297)			this->_hx___windows->remove(window);
HXLINE( 298)			this->windowByID->remove(window->id);
HXLINE( 299)			window->close();
HXLINE( 301)			if (hx::IsNotNull( window->renderer )) {
HXLINE( 303)				this->removeRenderer(window->renderer);
            			}
HXLINE( 307)			if (hx::IsEq( this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >(),window )) {
HXLINE( 309)				this->window = null();
            			}
HXLINE( 313)			if ((this->_hx___windows->length == (int)0)) {
HXLINE( 315)				::lime::_hx_system::System_obj::exit((int)0);
            			}
            		}
            	}
...
void Application_obj::setPreloader( ::lime::app::Preloader preloader){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_324_setPreloader)
HXLINE( 326)		this->super::setPreloader(preloader);
HXLINE( 328)		{
HXLINE( 328)			int _g = (int)0;
HXDLIN( 328)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 328)			while((_g < _g1->length)){
HXLINE( 328)				::Dynamic module = _g1->__get(_g);
HXDLIN( 328)				_g = (_g + (int)1);
HXLINE( 330)				::lime::app::IModule_obj::setPreloader(module,preloader);
            			}
            		}
            	}
...
Float Application_obj::get_frameRate(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_346_get_frameRate)
HXDLIN( 346)		return this->backend->getFrameRate();
            	}
...
Float Application_obj::set_frameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_353_set_frameRate)
HXDLIN( 353)		return this->backend->setFrameRate(value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,set_frameRate,return )
 ...
 ::lime::app::Preloader Application_obj::get_preloader(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_360_get_preloader)
HXDLIN( 360)		return this->_hx___preloader;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_preloader,return )
 ...
 ::lime::graphics::Renderer Application_obj::get_renderer(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_367_get_renderer)
HXDLIN( 367)		return this->_hx___renderers->__get((int)0).StaticCast<  ::lime::graphics::Renderer >();
            	}
...
::Array< ::Dynamic> Application_obj::get_renderers(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_374_get_renderers)
HXDLIN( 374)		return this->_hx___renderers;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_renderers,return )
 ...
 ::lime::ui::Window Application_obj::get_window(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_381_get_window)
HXDLIN( 381)		return this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >();
            	}
...
::Array< ::Dynamic> Application_obj::get_windows(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_388_get_windows)
HXDLIN( 388)		return this->_hx___windows;
            	}
