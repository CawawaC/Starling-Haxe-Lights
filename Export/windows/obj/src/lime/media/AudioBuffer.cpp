...
HX_DEFINE_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_57_new,"lime.media.AudioBuffer","new",0x18eea6a5,"lime.media.AudioBuffer.new","lime/media/AudioBuffer.hx",57,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_64_dispose,"lime.media.AudioBuffer","dispose",0xa3b05d64,"lime.media.AudioBuffer.dispose","lime/media/AudioBuffer.hx",64,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_515_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",515,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_548_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",548,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_92_fromBase64,"lime.media.AudioBuffer","fromBase64",0xbd10aef4,"lime.media.AudioBuffer.fromBase64","lime/media/AudioBuffer.hx",92,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_152_fromBytes,"lime.media.AudioBuffer","fromBytes",0x20c94aa6,"lime.media.AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",152,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_198_fromFile,"lime.media.AudioBuffer","fromFile",0x1084eca1,"lime.media.AudioBuffer.fromFile","lime/media/AudioBuffer.hx",198,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_281_fromFiles,"lime.media.AudioBuffer","fromFiles",0x63ca20b2,"lime.media.AudioBuffer.fromFiles","lime/media/AudioBuffer.hx",281,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_309_fromVorbisFile,"lime.media.AudioBuffer","fromVorbisFile",0x6dde6b54,"lime.media.AudioBuffer.fromVorbisFile","lime/media/AudioBuffer.hx",309,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_403_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",403,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_336_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",336,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_452_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",452,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_420_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",420,0xf6fabaad)
...
void AudioBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_57_new)
            	}
...
void AudioBuffer_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_64_dispose)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_515_get_src)
HXDLIN( 515)		return this->_hx___srcVorbisFile;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_548_set_src)
HXDLIN( 548)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::codecs::vorbis::VorbisFile)(value) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,set_src,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBase64(::String base64String){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_92_fromBase64)
HXLINE(  94)		if (hx::IsNull( base64String )) {
HXLINE(  94)			return null();
            		}
HXLINE( 117)		::Array< ::String > base64StringSplit = base64String.split(HX_(",",2c,00,00,00));
HXLINE( 118)		::String base64StringNoEncoding = base64StringSplit->__get((base64StringSplit->length - (int)1));
HXLINE( 119)		 ::haxe::io::Bytes bytes = ::haxe::crypto::Base64_obj::decode(base64StringNoEncoding,null());
HXLINE( 120)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 121)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 121)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 121)		if (hx::IsNotNull( buffer )) {
HXLINE( 121)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 121)			int in_byteOffset = (int)0;
HXDLIN( 121)			if ((in_byteOffset < (int)0)) {
HXLINE( 121)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 121)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 121)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 121)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 121)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 121)				if ((newByteLength < (int)0)) {
HXLINE( 121)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 121)		audioBuffer->data = this1;
HXLINE( 123)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_audio_load(hx::DynamicPtr(bytes),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBase64,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_152_fromBytes)
HXLINE( 154)		if (hx::IsNull( bytes )) {
HXLINE( 154)			return null();
            		}
HXLINE( 170)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 171)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 171)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 171)		if (hx::IsNotNull( buffer )) {
HXLINE( 171)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 171)			int in_byteOffset = (int)0;
...
HXLINE( 173)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_audio_load(hx::DynamicPtr(bytes),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBytes,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_198_fromFile)
HXLINE( 200)		if (hx::IsNull( path )) {
HXLINE( 200)			return null();
            		}
HXLINE( 249)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 250)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 250)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 250)		if (hx::IsNotNull( buffer )) {
HXLINE( 250)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 250)			int in_byteOffset = (int)0;
HXDLIN( 250)			if ((in_byteOffset < (int)0)) {
HXLINE( 250)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 250)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 250)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 250)			int bufferByteLength = buffer->length;
HXDLIN( 250)			int elementSize = _this->bytesPerElement;
HXDLIN( 250)			int newByteLength = bufferByteLength;
HXDLIN( 250)			{
HXLINE( 250)				newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN( 250)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 250)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 250)				if ((newByteLength < (int)0)) {
HXLINE( 250)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN( 250)			_this->buffer = buffer;
HXDLIN( 250)			_this->byteOffset = in_byteOffset;
HXDLIN( 250)			_this->byteLength = newByteLength;
HXDLIN( 250)			_this->length = ::Std_obj::_hx_int(((Float)newByteLength / (Float)_this->bytesPerElement));
HXDLIN( 250)			this1 = _this;
            		}
            		else {
HXLINE( 250)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 250)		audioBuffer->data = this1;
HXLINE( 252)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_audio_load(hx::DynamicPtr(path),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFile,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFiles(::Array< ::String > paths){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_281_fromFiles)
HXLINE( 291)		 ::lime::media::AudioBuffer buffer = null();
HXLINE( 293)		{
HXLINE( 293)			int _g = (int)0;
HXDLIN( 293)			while((_g < paths->length)){
HXLINE( 293)				::String path = paths->__get(_g);
HXDLIN( 293)				_g = (_g + (int)1);
HXLINE( 295)				buffer = ::lime::media::AudioBuffer_obj::fromFile(path);
HXLINE( 296)				if (hx::IsNotNull( buffer )) {
HXLINE( 296)					goto _hx_goto_7;
            				}
            			}
            			_hx_goto_7:;
            		}
HXLINE( 300)		return buffer;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFiles,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromVorbisFile( ::lime::media::codecs::vorbis::VorbisFile vorbisFile){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_309_fromVorbisFile)
HXLINE( 311)		if (hx::IsNull( vorbisFile )) {
HXLINE( 311)			return null();
            		}
HXLINE( 313)		 ::lime::media::codecs::vorbis::VorbisInfo info = vorbisFile->info(null());
HXLINE( 315)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 316)		audioBuffer->channels = info->channels;
HXLINE( 317)		audioBuffer->sampleRate = info->rate;
HXLINE( 318)		audioBuffer->bitsPerSample = (int)16;
HXLINE( 319)		audioBuffer->_hx___srcVorbisFile = vorbisFile;
HXLINE( 321)		return audioBuffer;
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::media::AudioBuffer buffer){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_403_loadFromFile)
HXLINE( 403)			if (hx::IsNotNull( buffer )) {
HXLINE( 405)				return ::lime::app::Future_obj::withValue(buffer);
            			}
            			else {
HXLINE( 409)				return ::lime::app::Future_obj::withError(HX_("",00,00,00,00));
            			}
HXLINE( 403)			return null();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_336_loadFromFile)
HXLINE( 400)		 ::lime::net::_HTTPRequest_lime_media_AudioBuffer request =  ::lime::net::_HTTPRequest_lime_media_AudioBuffer_obj::__alloc( HX_CTX ,null());
HXLINE( 401)		return request->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFiles(::Array< ::String > paths){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0,::Array< ::String >,paths) HXARGC(0)
            		 ::lime::media::AudioBuffer _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_452_loadFromFiles)
HXLINE( 452)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_420_loadFromFiles)
HXLINE( 422)		 ::lime::app::Promise_lime_media_AudioBuffer promise =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 452)		promise->completeWith( ::lime::app::Future_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(paths)),true));
HXLINE( 456)		return promise->future;
            	}
...
HXLINE( 463)		::String signature = bytes->getString((int)0,(int)4);
HXLINE( 465)		::String _hx_switch_0 = signature;
            		if (  (_hx_switch_0==HX_("OggS",44,5d,86,34)) ){
HXLINE( 467)			return HX_("audio/ogg",56,37,42,54);
HXDLIN( 467)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("RIFF",b7,20,6b,36)) ){
HXLINE( 469)			if ((bytes->getString((int)8,(int)4) == HX_("WAVE",b9,2d,b3,39))) {
HXLINE( 469)				return HX_("audio/wav",33,44,48,54);
            			}
            			else {
HXLINE( 472)				bool _hx_tmp;
HXDLIN( 472)				if ((bytes->getString((int)0,(int)3) != HX_("ID3",f8,9f,37,00))) {
HXLINE( 472)					_hx_tmp = (bytes->getString((int)0,(int)2) == HX_("\xc3""\xbf""\xc3""\xbb""",34,34,76,81));
            				}
            				else {
HXLINE( 472)					_hx_tmp = true;
            				}
HXDLIN( 472)				if (_hx_tmp) {
HXLINE( 474)					return HX_("audio/mp3",77,ba,40,54);
            				}
            			}
HXLINE( 469)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("fLaC",68,c3,a5,43)) ){
HXLINE( 468)			return HX_("audio/flac",c1,0e,bf,5f);
HXDLIN( 468)			goto _hx_goto_14;
            		}
            		/* default */{
HXLINE( 472)			bool _hx_tmp1;
HXDLIN( 472)			if ((bytes->getString((int)0,(int)3) != HX_("ID3",f8,9f,37,00))) {
HXLINE( 472)				_hx_tmp1 = (bytes->getString((int)0,(int)2) == HX_("\xc3""\xbf""\xc3""\xbb""",34,34,76,81));
            			}
            			else {
...
HXLINE( 474)				return HX_("audio/mp3",77,ba,40,54);
            		...
            		_hx_goto_14:;
HXLINE( 480)		::lime::utils::Log_obj::error(HX_("Unsupported sound format",d3,74,34,38),hx::SourceInfo(HX_("AudioBuffer.hx",28,d6,7b,8c),480,HX_("lime.media.AudioBuffer",33,70,4b,3a),HX_("__getCodec",40,d9,65,4d)));
