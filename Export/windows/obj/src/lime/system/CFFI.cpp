...
HXLINE( 269)		 ::Dynamic get_env = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("get_env",84,cc,c1,26),(int)1);
HXLINE( 270)		bool debug = hx::IsNotNull( get_env(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b)) );
HXLINE( 275)		if (debug) {
