...
HXDLIN(  71)		 ::openfl::_Vector::AbstractVector _g1 = this->stage->stage3Ds;
HXDLIN(  71)		while((_g < ::openfl::_Vector::IVector_obj::get_length(_g1->data))){
HXDLIN(  71)			 ::openfl::display::Stage3D stage3D = ( ( ::openfl::display::Stage3D)(::openfl::_Vector::IVector_obj::get(_g1->data,_g)) );
