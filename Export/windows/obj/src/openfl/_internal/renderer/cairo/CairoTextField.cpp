...
HXLINE( 248)								color2 = glowFilter->color;
...
HXLINE( 253)								cairo->setSourceRGBA(r2,g2,b2,glowFilter->alpha);
HXLINE( 254)								cairo->set_lineWidth(::Math_obj::max(glowFilter->blurX,glowFilter->blurY));
...
HXLINE( 288)										_hx_tmp14 = (position->glyph == (int)0);
            									}
            									else {
...
HXLINE( 299)							_hx_tmp15 = textEngine->selectable;
            						}
            						else {
...
HXLINE( 303)								bool _hx_tmp16;
HXDLIN( 303)								bool _hx_tmp17;
HXDLIN( 303)								if (textField->_hx___showCursor) {
HXLINE( 303)									_hx_tmp17 = (group->startIndex <= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 303)									_hx_tmp17 = false;
            								}
HXDLIN( 303)								if (_hx_tmp17) {
HXLINE( 303)									_hx_tmp16 = (group->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 303)									_hx_tmp16 = false;
            								}
HXDLIN( 303)								if (_hx_tmp16) {
...
HXLINE( 316)									{
HXLINE( 316)										int _g32 = (int)0;
HXDLIN( 316)										int _g23 = (textField->get_scrollV() - (int)1);
HXDLIN( 316)										while((_g32 < _g23)){
HXLINE( 316)											_g32 = (_g32 + (int)1);
HXDLIN( 316)											int i2 = (_g32 - (int)1);
HXLINE( 318)											scrollY1 = (scrollY1 - ( (Float)(::openfl::_Vector::IVector_obj::get(textEngine->lineHeights->data,i2)) ));
            										}
            									}
HXLINE( 322)									Float _hx_tmp18 = (::Math_obj::floor((group->offsetX + advance)) + ((Float)0.5));
HXDLIN( 322)									Float _hx_tmp19 = (_hx_tmp18 - textField->get_scrollH());
HXDLIN( 322)									cairo->moveTo(_hx_tmp19,(scrollY1 + ((Float)2.5)));
HXLINE( 323)									cairo->set_lineWidth((int)1);
HXLINE( 324)									Float _hx_tmp20 = (::Math_obj::floor((group->offsetX + advance)) + ((Float)0.5));
HXDLIN( 324)									Float _hx_tmp21 = (_hx_tmp20 - textField->get_scrollH());
HXDLIN( 324)									cairo->lineTo(_hx_tmp21,((scrollY1 + ::openfl::_internal::text::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - (int)1));
HXLINE( 325)									cairo->stroke();
            								}
            							}
            							else {
HXLINE( 329)								bool _hx_tmp22;
HXDLIN( 329)								bool _hx_tmp23;
HXDLIN( 329)								bool _hx_tmp24;
HXDLIN( 329)								bool _hx_tmp25;
HXDLIN( 329)								if ((group->startIndex <= textField->_hx___caretIndex)) {
HXLINE( 329)									_hx_tmp25 = (group->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
...
HXLINE( 329)										_hx_tmp23 = (group->endIndex < textField->_hx___selectionIndex);
            									}
            									else {
...
HXLINE( 329)									if ((group->startIndex > textField->_hx___selectionIndex)) {
HXLINE( 329)										_hx_tmp22 = (group->endIndex < textField->_hx___caretIndex);
            									}
            									else {
HXLINE( 329)										_hx_tmp22 = false;
            									}
            								}
            								else {
HXLINE( 329)									_hx_tmp22 = true;
            								}
HXDLIN( 329)								if (_hx_tmp22) {
...
HXLINE( 361)									bool _hx_tmp26;
HXDLIN( 361)									if (hx::IsNotNull( start )) {
HXLINE( 361)										_hx_tmp26 = hx::IsNotNull( end );
            									}
            									else {
HXLINE( 361)										_hx_tmp26 = false;
            									}
HXDLIN( 361)									if (_hx_tmp26) {
HXLINE( 363)										cairo->setSourceRGB((int)0,(int)0,(int)0);
HXLINE( 364)										Float _hx_tmp27 = (scrollX + start->x);
HXDLIN( 364)										Float _hx_tmp28 = (start->y + scrollY);
HXDLIN( 364)										cairo->rectangle(_hx_tmp27,_hx_tmp28,(end->x - start->x),group->height);
HXLINE( 365)										cairo->fill();
HXLINE( 366)										cairo->setSourceRGB((int)1,(int)1,(int)1);
HXLINE( 370)										Float _hx_tmp29 = (scrollX + start->x);
HXDLIN( 370)										cairo->moveTo(_hx_tmp29,((group->offsetY + group->ascent) + scrollY));
...
HXLINE( 383)			bool _hx_tmp30;
HXDLIN( 383)			bool _hx_tmp31;
HXDLIN( 383)			if ((textField->_hx___caretIndex > (int)-1)) {
HXLINE( 383)				_hx_tmp31 = textEngine->selectable;
            			}
            			else {
HXLINE( 383)				_hx_tmp31 = false;
            			}
HXDLIN( 383)			if (_hx_tmp31) {
HXLINE( 383)				_hx_tmp30 = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 383)				_hx_tmp30 = false;
            			}
HXDLIN( 383)			if (_hx_tmp30) {
