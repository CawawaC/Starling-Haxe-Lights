...
HXDLIN(  32)		if (hx::IsNotNull( bitmap->bitmapData )) {
HXLINE(  32)			_hx_tmp1 = bitmap->bitmapData->_hx___isValid;
            		}
            		else {
...
HXLINE(  45)			shader->get_data()->uImage0->input = bitmap->bitmapData;
...
HXDLIN(  55)			gl->bindBuffer(gl1,bitmap->bitmapData->getBuffer(gl,bitmap->_hx___worldAlpha,bitmap->_hx___worldColorTransform));
...
HXDLIN(  87)		if (hx::IsNotNull( bitmap->bitmapData )) {
HXDLIN(  87)			_hx_tmp = bitmap->bitmapData->_hx___isValid;
            		}
            		else {
...
HXLINE(  95)			shader->get_data()->uImage0->input = bitmap->bitmapData;
...
HXDLIN( 101)			gl->bindBuffer(gl1,bitmap->bitmapData->getBuffer(gl,bitmap->_hx___worldAlpha,bitmap->_hx___worldColorTransform));
