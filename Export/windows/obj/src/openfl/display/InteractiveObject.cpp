...
HX_DEFINE_STACK_FRAME(_hx_pos_762cd2e6f13bb015_41_new,"openfl.display.InteractiveObject","new",0x042d7309,"openfl.display.InteractiveObject.new","openfl/display/InteractiveObject.hx",41,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_54_requestSoftKeyboard,"openfl.display.InteractiveObject","requestSoftKeyboard",0x985d3a49,"openfl.display.InteractiveObject.requestSoftKeyboard","openfl/display/InteractiveObject.hx",54,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_65___allowMouseFocus,"openfl.display.InteractiveObject","__allowMouseFocus",0x4a3f2aa5,"openfl.display.InteractiveObject.__allowMouseFocus","openfl/display/InteractiveObject.hx",65,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_70___getInteractive,"openfl.display.InteractiveObject","__getInteractive",0xf3ec43c3,"openfl.display.InteractiveObject.__getInteractive","openfl/display/InteractiveObject.hx",70,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_89___hitTest,"openfl.display.InteractiveObject","__hitTest",0x5938388e,"openfl.display.InteractiveObject.__hitTest","openfl/display/InteractiveObject.hx",89,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_106_get_tabEnabled,"openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",106,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_113_set_tabEnabled,"openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",113,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_120_get_tabIndex,"openfl.display.InteractiveObject","get_tabIndex",0x2bde10bd,"openfl.display.InteractiveObject.get_tabIndex","openfl/display/InteractiveObject.hx",120,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_127_set_tabIndex,"openfl.display.InteractiveObject","set_tabIndex",0x40d73431,"openfl.display.InteractiveObject.set_tabIndex","openfl/display/InteractiveObject.hx",127,0x983a3689)
namespace openfl{
namespace display{

void InteractiveObject_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_41_new)
HXLINE(  43)		super::__construct();
HXLINE(  45)		this->doubleClickEnabled = false;
HXLINE(  46)		this->mouseEnabled = true;
HXLINE(  47)		this->needsSoftKeyboard = false;
HXLINE(  48)		this->_hx___tabEnabled = null();
HXLINE(  49)		this->_hx___tabIndex = (int)-1;
            	}
...
bool InteractiveObject_obj::requestSoftKeyboard(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_54_requestSoftKeyboard)
HXLINE(  56)		::openfl::_internal::Lib_obj::notImplemented(hx::SourceInfo(HX_("InteractiveObject.hx",3d,87,79,89),56,HX_("openfl.display.InteractiveObject",97,3a,cb,f4),HX_("requestSoftKeyboard",a0,f5,a9,d4)));
...
bool InteractiveObject_obj::_hx___allowMouseFocus(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_65___allowMouseFocus)
HXDLIN(  65)		return this->get_tabEnabled();
            	}
...
bool InteractiveObject_obj::_hx___getInteractive(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_70___getInteractive)
HXLINE(  72)		if (hx::IsNotNull( stack )) {
HXLINE(  74)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(  76)			if (hx::IsNotNull( this->parent )) {
HXLINE(  78)				this->parent->_hx___getInteractive(stack);
            			}
            		}
...
bool InteractiveObject_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_89___hitTest)
...
HXLINE(  91)			if (interactiveOnly) {
HXLINE(  91)				_hx_tmp = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE(  92)		return this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}


bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_106_get_tabEnabled)
HXDLIN( 106)		if (hx::IsEq( this->_hx___tabEnabled,true )) {
...
bool InteractiveObject_obj::set_tabEnabled(bool value){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_113_set_tabEnabled)
HXDLIN( 113)		return (this->_hx___tabEnabled = value);
            	}
...
int InteractiveObject_obj::get_tabIndex(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_120_get_tabIndex)
HXDLIN( 120)		return this->_hx___tabIndex;
            	}
...
int InteractiveObject_obj::set_tabIndex(int value){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_127_set_tabIndex)
HXDLIN( 127)		return (this->_hx___tabIndex = value);
            	}
