...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_72_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",72,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_84_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",84,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_99_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",99,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_104___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",104,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_174___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",174,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_184___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",184,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_194___renderCairo,"openfl.display.Stage3D","__renderCairo",0x4faad7c9,"openfl.display.Stage3D.__renderCairo","openfl/display/Stage3D.hx",194,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_208___renderCanvas,"openfl.display.Stage3D","__renderCanvas",0x69230677,"openfl.display.Stage3D.__renderCanvas","openfl/display/Stage3D.hx",208,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_222___renderDOM,"openfl.display.Stage3D","__renderDOM",0x9069cb83,"openfl.display.Stage3D.__renderDOM","openfl/display/Stage3D.hx",222,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_246___renderGL,"openfl.display.Stage3D","__renderGL",0x25621024,"openfl.display.Stage3D.__renderGL","openfl/display/Stage3D.hx",246,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_266___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",266,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_280___resetContext3DStates,"openfl.display.Stage3D","__resetContext3DStates",0x6c934f5c,"openfl.display.Stage3D.__resetContext3DStates","openfl/display/Stage3D.hx",280,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_292_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",292,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_297_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",297,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_316_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",316,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_321_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",321,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_72_new)
HXLINE(  74)		super::__construct(null());
HXLINE(  76)		this->_hx___x = (int)0;
HXLINE(  77)		this->_hx___y = (int)0;
HXLINE(  79)		this->visible = true;
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_84_requestContext3D)
HXLINE(  86)		this->_hx___contextRequested = true;
HXLINE(  88)		if (hx::IsNotNull( this->context3D )) {
HXLINE(  90)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::AbstractVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_99_requestContext3DMatchingProfiles)
HXDLIN(  99)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_104___createContext)
HXLINE( 106)		this->_hx___stage = stage;
HXLINE( 108)		if (hx::IsNotNull( renderSession->gl )) {
HXLINE( 110)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),renderSession);
HXLINE( 111)			this->_hx___dispatchCreate();
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_174___dispatchError)
HXLINE( 176)		this->_hx___contextRequested = false;
HXLINE( 177)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_184___dispatchCreate)
HXDLIN( 184)		if (this->_hx___contextRequested) {
HXLINE( 186)			this->_hx___contextRequested = false;
HXLINE( 187)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___renderCairo( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_194___renderCairo)
HXLINE( 196)		if (!(this->visible)) {
HXLINE( 196)			return;
            		}
HXLINE( 198)		if (this->_hx___contextRequested) {
HXLINE( 200)			this->_hx___dispatchError();
HXLINE( 201)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_208___renderCanvas)
HXLINE( 210)		if (!(this->visible)) {
HXLINE( 210)			return;
            		}
HXLINE( 212)		if (this->_hx___contextRequested) {
HXLINE( 214)			this->_hx___dispatchError();
...
void Stage3D_obj::_hx___renderDOM( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_222___renderDOM)
HXLINE( 224)		if (!(this->visible)) {
HXLINE( 224)			return;
            		}
HXLINE( 226)		bool _hx_tmp;
HXDLIN( 226)		if (this->_hx___contextRequested) {
HXLINE( 226)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 226)			_hx_tmp = false;
            		}
HXDLIN( 226)		if (_hx_tmp) {
HXLINE( 228)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 232)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 238)			this->_hx___resetContext3DStates();
            		}
            	}
...
void Stage3D_obj::_hx___renderGL( ::openfl::display::Stage stage, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_246___renderGL)
HXLINE( 248)		if (!(this->visible)) {
HXLINE( 248)			return;
            		}
HXLINE( 250)		bool _hx_tmp;
HXDLIN( 250)		if (this->_hx___contextRequested) {
HXLINE( 250)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 250)			_hx_tmp = false;
            		}
HXDLIN( 250)		if (_hx_tmp) {
HXLINE( 252)			this->_hx___createContext(stage,renderSession);
            		}
HXLINE( 256)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 258)			this->_hx___resetContext3DStates();
HXLINE( 259)			{
HXLINE( 259)				if (hx::IsNotNull( this->context3D )) {
HXLINE( 259)					renderSession->blendModeManager->setBlendMode(null());
HXDLIN( 259)					if (hx::IsNotNull( renderSession->shaderManager->currentShader )) {
HXLINE( 259)						renderSession->shaderManager->setShader(null());
HXDLIN( 259)						if (hx::IsNotNull( this->context3D->_hx___program )) {
HXLINE( 259)							this->context3D->_hx___program->_hx___use();
            						}
            					}
            				}
HXDLIN( 259)				if (::openfl::_internal::stage3D::GLUtils_obj::debug) {
HXLINE( 259)					renderSession->gl->getError();
            				}
            			}
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_266___resize)
            	}
...
void Stage3D_obj::_hx___resetContext3DStates(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_280___resetContext3DStates)
HXLINE( 283)		this->context3D->_hx___updateBlendFactors();
HXLINE( 285)		this->context3D->_hx___updateBackbufferViewport();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_292_get_x)
HXDLIN( 292)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_297_set_x)
HXLINE( 299)		if ((this->_hx___x == value)) {
HXLINE( 299)			return value;
            		}
HXLINE( 301)		this->_hx___x = value;
HXLINE( 303)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 305)			this->context3D->_hx___updateBackbufferViewport();
            		}
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_316_get_y)
HXDLIN( 316)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_321_set_y)
HXLINE( 323)		if ((this->_hx___y == value)) {
HXLINE( 323)			return value;
            		}
HXLINE( 325)		this->_hx___y = value;
HXLINE( 327)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 329)			this->context3D->_hx___updateBackbufferViewport();
            		}
