...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_908_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",908,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_908_new)
HXLINE( 910)		this->initFrame = initFrame;
HXLINE( 911)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 912)		this->characterID = characterID;
HXLINE( 913)		this->depth = depth;
HXLINE( 914)		this->displayObject = displayObject;
HXLINE( 915)		this->clipDepth = clipDepth;
            	}
