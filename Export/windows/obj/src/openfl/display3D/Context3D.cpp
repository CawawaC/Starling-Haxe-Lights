...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_114_clear,"openfl.display3D.Context3D","clear",0xf8808186,"openfl.display3D.Context3D.clear","openfl/display3D/Context3D.hx",114,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_121_configureBackBuffer,"openfl.display3D.Context3D","configureBackBuffer",0x7210edc6,"openfl.display3D.Context3D.configureBackBuffer","openfl/display3D/Context3D.hx",121,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_128_createCubeTexture,"openfl.display3D.Context3D","createCubeTexture",0xbb69e843,"openfl.display3D.Context3D.createCubeTexture","openfl/display3D/Context3D.hx",128,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_135_createIndexBuffer,"openfl.display3D.Context3D","createIndexBuffer",0x3b80e18f,"openfl.display3D.Context3D.createIndexBuffer","openfl/display3D/Context3D.hx",135,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_142_createProgram,"openfl.display3D.Context3D","createProgram",0x0b5753e1,"openfl.display3D.Context3D.createProgram","openfl/display3D/Context3D.hx",142,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_149_createRectangleTexture,"openfl.display3D.Context3D","createRectangleTexture",0x8720f36f,"openfl.display3D.Context3D.createRectangleTexture","openfl/display3D/Context3D.hx",149,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_156_createTexture,"openfl.display3D.Context3D","createTexture",0xb63ed238,"openfl.display3D.Context3D.createTexture","openfl/display3D/Context3D.hx",156,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_163_createVertexBuffer,"openfl.display3D.Context3D","createVertexBuffer",0x49fb9507,"openfl.display3D.Context3D.createVertexBuffer","openfl/display3D/Context3D.hx",163,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_173_createVideoTexture,"openfl.display3D.Context3D","createVideoTexture",0x922f1723,"openfl.display3D.Context3D.createVideoTexture","openfl/display3D/Context3D.hx",173,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_181_dispose,"openfl.display3D.Context3D","dispose",0x8ad040d8,"openfl.display3D.Context3D.dispose","openfl/display3D/Context3D.hx",181,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_186_drawToBitmapData,"openfl.display3D.Context3D","drawToBitmapData",0x474f45df,"openfl.display3D.Context3D.drawToBitmapData","openfl/display3D/Context3D.hx",186,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_195_drawTriangles,"openfl.display3D.Context3D","drawTriangles",0x0d837500,"openfl.display3D.Context3D.drawTriangles","openfl/display3D/Context3D.hx",195,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_211_present,"openfl.display3D.Context3D","present",0x095ffb34,"openfl.display3D.Context3D.present","openfl/display3D/Context3D.hx",211,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_218_setBlendFactors,"openfl.display3D.Context3D","setBlendFactors",0x86d16c6e,"openfl.display3D.Context3D.setBlendFactors","openfl/display3D/Context3D.hx",218,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_225_setColorMask,"openfl.display3D.Context3D","setColorMask",0xad4f5d14,"openfl.display3D.Context3D.setColorMask","openfl/display3D/Context3D.hx",225,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_232_setCulling,"openfl.display3D.Context3D","setCulling",0x39687055,"openfl.display3D.Context3D.setCulling","openfl/display3D/Context3D.hx",232,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_239_setDepthTest,"openfl.display3D.Context3D","setDepthTest",0x2d08b41a,"openfl.display3D.Context3D.setDepthTest","openfl/display3D/Context3D.hx",239,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_244_setProgram,"openfl.display3D.Context3D","setProgram",0xd9d9d869,"openfl.display3D.Context3D.setProgram","openfl/display3D/Context3D.hx",244,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_257_setProgramConstantsFromByteArray,"openfl.display3D.Context3D","setProgramConstantsFromByteArray",0xd8990de1,"openfl.display3D.Context3D.setProgramConstantsFromByteArray","openfl/display3D/Context3D.hx",257,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_268_setProgramConstantsFromMatrix,"openfl.display3D.Context3D","setProgramConstantsFromMatrix",0x29e843d1,"openfl.display3D.Context3D.setProgramConstantsFromMatrix","openfl/display3D/Context3D.hx",268,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_273_setProgramConstantsFromVector,"openfl.display3D.Context3D","setProgramConstantsFromVector",0x057dbe53,"openfl.display3D.Context3D.setProgramConstantsFromVector","openfl/display3D/Context3D.hx",273,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_284_setRenderToBackBuffer,"openfl.display3D.Context3D","setRenderToBackBuffer",0x6095d693,"openfl.display3D.Context3D.setRenderToBackBuffer","openfl/display3D/Context3D.hx",284,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_291_setRenderToTexture,"openfl.display3D.Context3D","setRenderToTexture",0x25c5d54f,"openfl.display3D.Context3D.setRenderToTexture","openfl/display3D/Context3D.hx",291,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_298_setSamplerStateAt,"openfl.display3D.Context3D","setSamplerStateAt",0x9f8ad1f7,"openfl.display3D.Context3D.setSamplerStateAt","openfl/display3D/Context3D.hx",298,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_305_setScissorRectangle,"openfl.display3D.Context3D","setScissorRectangle",0x712bb5ee,"openfl.display3D.Context3D.setScissorRectangle","openfl/display3D/Context3D.hx",305,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_312_setStencilActions,"openfl.display3D.Context3D","setStencilActions",0x1fe08e1c,"openfl.display3D.Context3D.setStencilActions","openfl/display3D/Context3D.hx",312,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_319_setStencilReferenceValue,"openfl.display3D.Context3D","setStencilReferenceValue",0xaa284f67,"openfl.display3D.Context3D.setStencilReferenceValue","openfl/display3D/Context3D.hx",319,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_326_setTextureAt,"openfl.display3D.Context3D","setTextureAt",0x38d4bfd3,"openfl.display3D.Context3D.setTextureAt","openfl/display3D/Context3D.hx",326,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_333_setVertexBufferAt,"openfl.display3D.Context3D","setVertexBufferAt",0xbb32fa52,"openfl.display3D.Context3D.setVertexBufferAt","openfl/display3D/Context3D.hx",333,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_340___updateBackbufferViewport,"openfl.display3D.Context3D","__updateBackbufferViewport",0x1ffcf0dd,"openfl.display3D.Context3D.__updateBackbufferViewport","openfl/display3D/Context3D.hx",340,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_347___updateBlendFactors,"openfl.display3D.Context3D","__updateBlendFactors",0x00141f63,"openfl.display3D.Context3D.__updateBlendFactors","openfl/display3D/Context3D.hx",347,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_359_set_enableErrorChecking,"openfl.display3D.Context3D","set_enableErrorChecking",0x101dce5b,"openfl.display3D.Context3D.set_enableErrorChecking","openfl/display3D/Context3D.hx",359,0xc899cbb9)
...
HXLINE( 102)		super::__construct(null());
HXLINE( 104)		this->_hx___stage3D = stage3D;
HXLINE( 105)		this->_hx___renderSession = renderSession;
HXLINE( 107)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::create(hx::ObjectPtr<OBJ_>(this));
            	}
...
int mask = __o_mask.Default(7);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_114_clear)
HXDLIN( 114)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::clear(hx::ObjectPtr<OBJ_>(this),red,green,blue,alpha,depth,stencil,mask);
            	}
...
bool wantsBestResolutionOnBrowserZoom = __o_wantsBestResolutionOnBrowserZoom.Default(false);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_121_configureBackBuffer)
HXDLIN( 121)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::configureBackBuffer(hx::ObjectPtr<OBJ_>(this),width,height,antiAlias,enableDepthAndStencil,wantsBestResolution,wantsBestResolutionOnBrowserZoom);
            	}
...
int streamingLevels = __o_streamingLevels.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_128_createCubeTexture)
HXDLIN( 128)		return  ::openfl::display3D::textures::CubeTexture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),size,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(Context3D_obj,createCubeTexture,return )
 ...
 ::Dynamic bufferUsage = __o_bufferUsage.Default(1);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_135_createIndexBuffer)
HXDLIN( 135)		return  ::openfl::display3D::IndexBuffer3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),numIndices,bufferUsage);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Context3D_obj,createIndexBuffer,return )
 ...
 ::openfl::display3D::Program3D Context3D_obj::createProgram(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_142_createProgram)
HXDLIN( 142)		return  ::openfl::display3D::Program3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Context3D_obj,createProgram,return )
 ...
 ::openfl::display3D::textures::RectangleTexture Context3D_obj::createRectangleTexture(int width,int height, ::Dynamic format,bool optimizeForRenderToTexture){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_149_createRectangleTexture)
HXDLIN( 149)		return  ::openfl::display3D::textures::RectangleTexture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),width,height,::openfl::display3D::_Context3DTextureFormat::Context3DTextureFormat_Impl__obj::toString(format),optimizeForRenderToTexture);
            	}
...
int streamingLevels = __o_streamingLevels.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_156_createTexture)
HXDLIN( 156)		return  ::openfl::display3D::textures::Texture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),width,height,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(Context3D_obj,createTexture,return )
 ...
 ::Dynamic bufferUsage = __o_bufferUsage.Default(1);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_163_createVertexBuffer)
HXDLIN( 163)		return  ::openfl::display3D::VertexBuffer3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),numVertices,data32PerVertex,::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::toString(bufferUsage));
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Context3D_obj,createVertexBuffer,return )
 ...
 ::openfl::display3D::textures::VideoTexture Context3D_obj::createVideoTexture(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_173_createVideoTexture)
HXDLIN( 173)		HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Video textures are not supported on this platform",02,cd,86,ca),null()));
...
bool recreate = __o_recreate.Default(true);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_181_dispose)
HXDLIN( 181)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::dispose(hx::ObjectPtr<OBJ_>(this),recreate);
            	}
...
void Context3D_obj::drawToBitmapData( ::openfl::display::BitmapData destination){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_186_drawToBitmapData)
HXLINE( 188)		if (hx::IsNull( destination )) {
HXLINE( 188)			return;
            		}
HXLINE( 190)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::drawToBitmapData(hx::ObjectPtr<OBJ_>(this),destination);
            	}
...
int numTriangles = __o_numTriangles.Default(-1);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_195_drawTriangles)
HXLINE( 197)		if (hx::IsNull( this->_hx___program )) {
HXLINE( 199)			return;
            		}
HXLINE( 203)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::drawTriangles(hx::ObjectPtr<OBJ_>(this),indexBuffer,firstIndex,numTriangles);
            	}
...
void Context3D_obj::present(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_211_present)
HXDLIN( 211)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::present(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Context3D_obj::setBlendFactors( ::Dynamic sourceFactor, ::Dynamic destinationFactor){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_218_setBlendFactors)
HXDLIN( 218)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setBlendFactors(hx::ObjectPtr<OBJ_>(this),sourceFactor,destinationFactor);
            	}
...
void Context3D_obj::setColorMask(bool red,bool green,bool blue,bool alpha){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_225_setColorMask)
HXDLIN( 225)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setColorMask(hx::ObjectPtr<OBJ_>(this),red,green,blue,alpha);
            	}
...
void Context3D_obj::setCulling( ::Dynamic triangleFaceToCull){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_232_setCulling)
HXDLIN( 232)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setCulling(hx::ObjectPtr<OBJ_>(this),triangleFaceToCull);
            	}
...
void Context3D_obj::setDepthTest(bool depthMask, ::Dynamic passCompareMode){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_239_setDepthTest)
HXDLIN( 239)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setDepthTest(hx::ObjectPtr<OBJ_>(this),depthMask,passCompareMode);
            	}
...
void Context3D_obj::setProgram( ::openfl::display3D::Program3D program){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_244_setProgram)
HXLINE( 246)		if (hx::IsNull( program )) {
HXLINE( 248)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 252)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgram(hx::ObjectPtr<OBJ_>(this),program);
            	}
...
void Context3D_obj::setProgramConstantsFromByteArray( ::Dynamic programType,int firstRegister,int numRegisters, ::openfl::utils::ByteArrayData data,int byteArrayOffset){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_257_setProgramConstantsFromByteArray)
HXLINE( 259)		if ((numRegisters == (int)0)) {
HXLINE( 259)			return;
            		}
HXLINE( 261)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromByteArray(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,numRegisters,data,byteArrayOffset);
            	}
...
bool transposedMatrix = __o_transposedMatrix.Default(false);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_268_setProgramConstantsFromMatrix)
HXDLIN( 268)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromMatrix(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,matrix,transposedMatrix);
            	}
...
int numRegisters = __o_numRegisters.Default(-1);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_273_setProgramConstantsFromVector)
HXLINE( 275)		if ((numRegisters == (int)0)) {
HXLINE( 275)			return;
            		}
HXLINE( 277)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromVector(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,data,numRegisters);
            	}
...
void Context3D_obj::setRenderToBackBuffer(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_284_setRenderToBackBuffer)
HXDLIN( 284)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setRenderToBackBuffer(hx::ObjectPtr<OBJ_>(this));
            	}
...
int surfaceSelector = __o_surfaceSelector.Default(0);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_291_setRenderToTexture)
HXDLIN( 291)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setRenderToTexture(hx::ObjectPtr<OBJ_>(this),texture,enableDepthAndStencil,antiAlias,surfaceSelector);
            	}
...
void Context3D_obj::setSamplerStateAt(int sampler, ::Dynamic wrap, ::Dynamic filter, ::Dynamic mipfilter){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_298_setSamplerStateAt)
HXDLIN( 298)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setSamplerStateAt(hx::ObjectPtr<OBJ_>(this),sampler,wrap,filter,mipfilter);
            	}
...
void Context3D_obj::setScissorRectangle( ::openfl::geom::Rectangle rectangle){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_305_setScissorRectangle)
HXDLIN( 305)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setScissorRectangle(hx::ObjectPtr<OBJ_>(this),rectangle);
            	}
...
void Context3D_obj::setStencilActions( ::Dynamic __o_triangleFace, ::Dynamic __o_compareMode, ::Dynamic __o_actionOnBothPass, ::Dynamic __o_actionOnDepthFail, ::Dynamic __o_actionOnDepthPassStencilFail){
 ...
 ::Dynamic actionOnDepthPassStencilFail = __o_actionOnDepthPassStencilFail.Default(5);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_312_setStencilActions)
HXDLIN( 312)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setStencilActions(hx::ObjectPtr<OBJ_>(this),triangleFace,compareMode,actionOnBothPass,actionOnDepthFail,actionOnDepthPassStencilFail);
            	}
...
int writeMask = __o_writeMask.Default(255);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_319_setStencilReferenceValue)
HXDLIN( 319)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setStencilReferenceValue(hx::ObjectPtr<OBJ_>(this),referenceValue,readMask,writeMask);
            	}
...
void Context3D_obj::setTextureAt(int sampler, ::openfl::display3D::textures::TextureBase texture){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_326_setTextureAt)
HXDLIN( 326)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setTextureAt(hx::ObjectPtr<OBJ_>(this),sampler,texture);
            	}
...
int bufferOffset = __o_bufferOffset.Default(0);
 ::Dynamic format = __o_format.Default(4);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_333_setVertexBufferAt)
HXDLIN( 333)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setVertexBufferAt(hx::ObjectPtr<OBJ_>(this),index,buffer,bufferOffset,format);
            	}
...
void Context3D_obj::_hx___updateBackbufferViewport(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_340___updateBackbufferViewport)
HXDLIN( 340)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateBackbufferViewportTEMP(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Context3D_obj::_hx___updateBlendFactors(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_347___updateBlendFactors)
HXDLIN( 347)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateBlendFactorsTEMP(hx::ObjectPtr<OBJ_>(this));
            	}
...
bool Context3D_obj::set_enableErrorChecking(bool value){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_359_set_enableErrorChecking)
HXLINE( 361)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setEnableErrorChecking(value);
HXLINE( 362)		return (this->enableErrorChecking = value);
            	}
