...
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_372_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",372,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_373_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",373,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_374_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",374,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_375_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",375,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_376_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",376,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_377_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",377,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_378_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",378,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_d75712e93d25d4a6_379_boot,"openfl.display3D._Context3D.Context3DTelemetry_Impl_","boot",0xa804c893,"openfl.display3D._Context3D.Context3DTelemetry_Impl_.boot","openfl/display3D/Context3D.hx",379,0xc899cbb9)
...
{
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_372_boot)
HXDLIN( 372)		DRAW_CALLS = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_373_boot)
HXDLIN( 373)		COUNT_INDEX_BUFFER = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_374_boot)
HXDLIN( 374)		COUNT_VERTEX_BUFFER = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_375_boot)
HXDLIN( 375)		COUNT_TEXTURE = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_376_boot)
HXDLIN( 376)		COUNT_TEXTURE_COMPRESSED = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_377_boot)
HXDLIN( 377)		COUNT_PROGRAM = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_378_boot)
HXDLIN( 378)		MEM_INDEX_BUFFER = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_379_boot)
HXDLIN( 379)		MEM_VERTEX_BUFFER = (int)7;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_380_boot)
HXDLIN( 380)		MEM_TEXTURE = (int)8;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_381_boot)
HXDLIN( 381)		MEM_TEXTURE_COMPRESSED = (int)9;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_382_boot)
HXDLIN( 382)		MEM_PROGRAM = (int)10;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d75712e93d25d4a6_384_boot)
HXDLIN( 384)		length = (int)11;
            	}
}
