...
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_80___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",80,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_92_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",92,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_105_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",105,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_118_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",118,0x46563eac)
namespace openfl{
namespace filters{
...
HXLINE(  55)		return sourceBitmapData;
 ...
 ::openfl::display::Shader BlurFilter_obj::_hx___initShader( ::openfl::_internal::renderer::RenderSession renderSession,int pass){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_80___initShader)
HXDLIN(  80)		return null();
            	}


Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_92_set_blurX)
HXLINE(  94)		if ((value != this->blurX)) {
HXLINE(  95)			this->blurX = value;
HXLINE(  96)			this->_hx___renderDirty = true;
HXLINE(  97)			int _hx_tmp;
HXDLIN(  97)			if ((value > (int)0)) {
HXLINE(  97)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE(  97)				_hx_tmp = (int)0;
            			}
HXDLIN(  97)			this->_hx___leftExtension = _hx_tmp;
HXLINE(  98)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_105_set_blurY)
HXLINE( 107)		if ((value != this->blurY)) {
HXLINE( 108)			this->blurY = value;
HXLINE( 109)			this->_hx___renderDirty = true;
HXLINE( 110)			int _hx_tmp;
HXDLIN( 110)			if ((value > (int)0)) {
HXLINE( 110)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 110)				_hx_tmp = (int)0;
            			}
HXDLIN( 110)			this->_hx___topExtension = _hx_tmp;
HXLINE( 111)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_118_set_quality)
HXLINE( 122)		int _hx_tmp;
HXDLIN( 122)		if ((this->blurX <= (int)0)) {
HXLINE( 122)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 122)			Float _hx_tmp1 = this->blurX;
HXDLIN( 122)			_hx_tmp = (::Math_obj::round((_hx_tmp1 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 122)		this->horizontalPasses = _hx_tmp;
HXLINE( 123)		int _hx_tmp2;
HXDLIN( 123)		if ((this->blurY <= (int)0)) {
HXLINE( 123)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 123)			Float _hx_tmp3 = this->blurY;
HXDLIN( 123)			_hx_tmp2 = (::Math_obj::round((_hx_tmp3 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 123)		this->verticalPasses = _hx_tmp2;
HXLINE( 125)		this->_hx___numShaderPasses = (this->horizontalPasses + this->verticalPasses);
HXLINE( 127)		if ((value != this->quality)) {
HXLINE( 127)			this->_hx___renderDirty = true;
            		}
HXLINE( 128)		return (this->quality = value);
            	}
