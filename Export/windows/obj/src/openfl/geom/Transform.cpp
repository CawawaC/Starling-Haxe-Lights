...
HX_DEFINE_STACK_FRAME(_hx_pos_c4822148baac23ea_46_new,"openfl.geom.Transform","new",0x993cc92a,"openfl.geom.Transform.new","openfl/geom/Transform.hx",46,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_67_get_colorTransform,"openfl.geom.Transform","get_colorTransform",0xc8c832c8,"openfl.geom.Transform.get_colorTransform","openfl/geom/Transform.hx",67,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_72_set_colorTransform,"openfl.geom.Transform","set_colorTransform",0xa577653c,"openfl.geom.Transform.set_colorTransform","openfl/geom/Transform.hx",72,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_93_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",93,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_106_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",106,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_119_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",119,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_142_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",142,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_156_set_matrix3D,"openfl.geom.Transform","set_matrix3D",0x1a00aaa5,"openfl.geom.Transform.set_matrix3D","openfl/geom/Transform.hx",156,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_177___setTransform,"openfl.geom.Transform","__setTransform",0x9df9f800,"openfl.geom.Transform.__setTransform","openfl/geom/Transform.hx",177,0xf4f475e6)
namespace openfl{
namespace geom{

void Transform_obj::__construct( ::openfl::display::DisplayObject displayObject){
            	HX_GC_STACKFRAME(&_hx_pos_c4822148baac23ea_46_new)
HXLINE(  48)		this->_hx___colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  49)		this->concatenatedColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  50)		this->pixelBounds =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE(  52)		this->_hx___displayObject = displayObject;
HXLINE(  53)		this->_hx___hasMatrix = true;
            	}
...
bool Transform_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::geom::ColorTransform Transform_obj::get_colorTransform(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_67_get_colorTransform)
HXDLIN(  67)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_colorTransform,return )
 ...
 ::openfl::geom::ColorTransform Transform_obj::set_colorTransform( ::openfl::geom::ColorTransform value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_72_set_colorTransform)
HXLINE(  74)		if (!(this->_hx___colorTransform->_hx___equals(value,null()))) {
HXLINE(  76)			this->_hx___colorTransform = value;
HXLINE(  78)			if (hx::IsNotNull( value )) {
HXLINE(  80)				this->_hx___displayObject->set_alpha(value->alphaMultiplier);
            			}
HXLINE(  84)			{
HXLINE(  84)				 ::openfl::display::DisplayObject _this = this->_hx___displayObject;
HXDLIN(  84)				if (!(_this->_hx___renderDirty)) {
HXLINE(  84)					_this->_hx___renderDirty = true;
HXDLIN(  84)					_this->_hx___setParentRenderDirty();
            				}
            			}
            		}
HXLINE(  88)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_colorTransform,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_93_get_concatenatedMatrix)
HXLINE(  95)		if (this->_hx___hasMatrix) {
HXLINE(  97)			return this->_hx___displayObject->_hx___getWorldTransform()->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_concatenatedMatrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_106_get_matrix)
HXLINE( 108)		if (this->_hx___hasMatrix) {
HXLINE( 110)			return this->_hx___displayObject->_hx___transform->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_119_set_matrix)
HXLINE( 121)		if (hx::IsNull( value )) {
HXLINE( 123)			this->_hx___hasMatrix = false;
HXLINE( 124)			return null();
            		}
HXLINE( 128)		this->_hx___hasMatrix = true;
HXLINE( 129)		this->_hx___hasMatrix3D = false;
HXLINE( 131)		if (hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 133)			this->_hx___setTransform(value->a,value->b,value->c,value->d,value->tx,value->ty);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_matrix,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::get_matrix3D(){
            	HX_GC_STACKFRAME(&_hx_pos_c4822148baac23ea_142_get_matrix3D)
HXLINE( 144)		if (this->_hx___hasMatrix3D) {
HXLINE( 146)			 ::openfl::geom::Matrix matrix = this->_hx___displayObject->_hx___transform;
HXLINE( 147)			::Array< Float > a = ::Array_obj< Float >::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0));
HXDLIN( 147)			int length = null();
HXDLIN( 147)			bool fixed = null();
HXDLIN( 147)			 ::openfl::_Vector::AbstractVector vector =  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null()),null());
HXDLIN( 147)			{
HXLINE( 147)				int _g1 = (int)0;
HXDLIN( 147)				int _g = a->length;
HXDLIN( 147)				while((_g1 < _g)){
HXLINE( 147)					_g1 = (_g1 + (int)1);
HXDLIN( 147)					int i = (_g1 - (int)1);
HXDLIN( 147)					::openfl::_Vector::IVector_obj::set(vector->data,i,a->__get(i));
            				}
            			}
HXDLIN( 147)			return  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,vector);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix3D,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::set_matrix3D( ::openfl::geom::Matrix3D value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_156_set_matrix3D)
HXLINE( 158)		if (hx::IsNull( value )) {
HXLINE( 160)			this->_hx___hasMatrix3D = false;
HXLINE( 161)			return null();
            		}
HXLINE( 165)		this->_hx___hasMatrix = false;
HXLINE( 166)		this->_hx___hasMatrix3D = true;
HXLINE( 168)		Float _hx_tmp = ( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)0)) );
HXDLIN( 168)		Float _hx_tmp1 = ( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)1)) );
HXDLIN( 168)		Float _hx_tmp2 = ( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)5)) );
HXDLIN( 168)		Float _hx_tmp3 = ( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)6)) );
HXDLIN( 168)		Float _hx_tmp4 = ( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)12)) );
HXDLIN( 168)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,( (Float)(::openfl::_Vector::IVector_obj::get(value->rawData->data,(int)13)) ));
...
void Transform_obj::_hx___setTransform(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_177___setTransform)
HXDLIN( 177)		if (hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 179)			Float scaleX = ((Float)0.0);
HXLINE( 180)			Float scaleY = ((Float)0.0);
HXLINE( 182)			if ((b == (int)0)) {
HXLINE( 184)				scaleX = a;
            			}
            			else {
HXLINE( 188)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 192)			if ((c == (int)0)) {
HXLINE( 194)				scaleY = a;
            			}
            			else {
HXLINE( 198)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 202)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 203)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 205)			Float rotation = ((Float)(int)180 / (Float)::Math_obj::PI);
HXDLIN( 205)			Float rotation1 = ((rotation * ::Math_obj::atan2(d,c)) - (int)90);
HXLINE( 207)			if ((rotation1 != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 209)				this->_hx___displayObject->_hx___rotation = rotation1;
HXLINE( 210)				Float radians = (rotation1 * ((Float)::Math_obj::PI / (Float)(int)180));
HXLINE( 211)				this->_hx___displayObject->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 212)				this->_hx___displayObject->_hx___rotationCosine = ::Math_obj::cos(radians);
            			}
HXLINE( 216)			this->_hx___displayObject->_hx___transform->a = a;
HXLINE( 217)			this->_hx___displayObject->_hx___transform->b = b;
HXLINE( 218)			this->_hx___displayObject->_hx___transform->c = c;
HXLINE( 219)			this->_hx___displayObject->_hx___transform->d = d;
HXLINE( 220)			this->_hx___displayObject->_hx___transform->tx = tx;
HXLINE( 221)			this->_hx___displayObject->_hx___transform->ty = ty;
HXLINE( 223)			this->_hx___displayObject->_hx___setTransformDirty();
            		}
            	}
