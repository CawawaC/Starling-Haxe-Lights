...
HX_DEFINE_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_38_new,"openfl.media.SoundChannel","new",0xfc94e2ae,"openfl.media.SoundChannel.new","openfl/media/SoundChannel.hx",38,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_70_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",70,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_82___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",82,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_95___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",95,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_107_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",107,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_116_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",116,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_128_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",128,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_133_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",133,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_174_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",174,0xa4290000)
namespace openfl{
namespace media{

void SoundChannel_obj::__construct( ::lime::media::AudioSource source, ::openfl::media::SoundTransform soundTransform){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_38_new)
HXLINE(  40)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  42)		this->leftPeak = (int)1;
HXLINE(  43)		this->rightPeak = (int)1;
HXLINE(  45)		if (hx::IsNotNull( soundTransform )) {
HXLINE(  47)			this->_hx___soundTransform = soundTransform;
            		}
            		else {
HXLINE(  51)			this->_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE(  55)		if (hx::IsNotNull( source )) {
HXLINE(  57)			this->_hx___source = source;
HXLINE(  58)			this->_hx___source->onComplete->add(this->source_onComplete_dyn(),null(),null());
HXLINE(  59)			this->_hx___isValid = true;
HXLINE(  61)			this->_hx___source->play();
            		}
HXLINE(  65)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_70_stop)
HXLINE(  72)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE(  74)		if (!(this->_hx___isValid)) {
HXLINE(  74)			return;
            		}
HXLINE(  76)		this->_hx___source->stop();
HXLINE(  77)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_82___dispose)
HXLINE(  84)		if (!(this->_hx___isValid)) {
HXLINE(  84)			return;
            		}
HXLINE(  86)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE(  87)		this->_hx___source->dispose();
HXLINE(  88)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_95___updateTransform)
HXDLIN(  95)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_107_get_position)
HXLINE( 109)		if (!(this->_hx___isValid)) {
HXLINE( 109)			return (int)0;
            		}
HXLINE( 111)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 111)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_116_set_position)
HXLINE( 118)		if (!(this->_hx___isValid)) {
HXLINE( 118)			return (int)0;
            		}
HXLINE( 120)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 120)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 120)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_128_get_soundTransform)
HXDLIN( 128)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_133_set_soundTransform)
HXLINE( 135)		if (hx::IsNotNull( value )) {
HXLINE( 137)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 138)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 140)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
...
HXLINE( 145)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 147)			if (this->_hx___isValid) {
HXLINE( 149)				this->_hx___source->set_gain(volume);
HXLINE( 151)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 152)				position->x = pan;
HXLINE( 153)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 154)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_174_source_onComplete)
HXLINE( 176)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 178)		this->_hx___dispose();
HXLINE( 179)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
