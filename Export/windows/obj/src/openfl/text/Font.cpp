...
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_109___initialize,"openfl.text.Font","__initialize",0x3f396f6c,"openfl.text.Font.__initialize","openfl/text/Font.hx",109,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_142_get_fontName,"openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",142,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_149_set_fontName,"openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",149,0x076bbaac)
...
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_79_registerFont,"openfl.text.Font","registerFont",0xd99a60ce,"openfl.text.Font.registerFont","openfl/text/Font.hx",79,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_99___fromLimeFont,"openfl.text.Font","__fromLimeFont",0x57c4282a,"openfl.text.Font.__fromLimeFont","openfl/text/Font.hx",99,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_21_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",21,0x076bbaac)
...
bool Font_obj::_hx___initialize(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_109___initialize)
HXLINE( 112)		if (!(this->_hx___initialized)) {
HXLINE( 114)			if (hx::IsNotNull( this->src )) {
HXLINE( 116)				this->_hx___initialized = true;
            			}
            			else {
HXLINE( 118)				bool _hx_tmp;
HXDLIN( 118)				bool _hx_tmp1;
HXDLIN( 118)				if (hx::IsNull( this->src )) {
HXLINE( 118)					_hx_tmp1 = hx::IsNotNull( this->_hx___fontID );
            				}
            				else {
HXLINE( 118)					_hx_tmp1 = false;
            				}
HXDLIN( 118)				if (_hx_tmp1) {
HXLINE( 118)					_hx_tmp = ::openfl::utils::Assets_obj::isLocal(this->_hx___fontID,null(),null());
            				}
            				else {
HXLINE( 118)					_hx_tmp = false;
            				}
HXDLIN( 118)				if (_hx_tmp) {
HXLINE( 120)					this->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(::openfl::utils::Assets_obj::getBytes(this->_hx___fontID)));
HXLINE( 121)					this->_hx___initialized = true;
            				}
            			}
            		}
HXLINE( 128)		return this->_hx___initialized;
            	}
...
::String Font_obj::get_fontName(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_142_get_fontName)
HXDLIN( 142)		return this->name;
            	}
...
::String Font_obj::set_fontName(::String value){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_149_set_fontName)
HXDLIN( 149)		return (this->name = value);
            	}
...
void Font_obj::registerFont(hx::Class font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_79_registerFont)
HXLINE(  81)		 ::openfl::text::Font instance = hx::TCast<  ::openfl::text::Font >::cast(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0)));
HXLINE(  83)		if (hx::IsNotNull( instance )) {
HXLINE(  91)			::openfl::text::Font_obj::_hx___registeredFonts->push(instance);
HXLINE(  92)			::openfl::text::Font_obj::_hx___fontByName->set(instance->name,instance);
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,registerFont,(void))
 ...
 ::openfl::text::Font Font_obj::_hx___fromLimeFont( ::lime::text::Font value){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_99___fromLimeFont)
HXLINE( 101)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 102)		font->name = value->name;
HXLINE( 103)		font->src = value->src;
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_21_boot)
HXDLIN(  21)		_hx___fontByName =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_22_boot)
HXDLIN(  22)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
}
