...
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_67_getCachedSamples,"openfl.ui.GameInputDevice","getCachedSamples",0x0422a56d,"openfl.ui.GameInputDevice.getCachedSamples","openfl/ui/GameInputDevice.hx",67,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_72_getControlAt,"openfl.ui.GameInputDevice","getControlAt",0xc65be2d6,"openfl.ui.GameInputDevice.getControlAt","openfl/ui/GameInputDevice.hx",72,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_85_startCachingSamples,"openfl.ui.GameInputDevice","startCachingSamples",0xf3794db0,"openfl.ui.GameInputDevice.startCachingSamples","openfl/ui/GameInputDevice.hx",85,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_92_stopCachingSamples,"openfl.ui.GameInputDevice","stopCachingSamples",0xbbb05408,"openfl.ui.GameInputDevice.stopCachingSamples","openfl/ui/GameInputDevice.hx",92,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_108_get_numControls,"openfl.ui.GameInputDevice","get_numControls",0x2a978757,"openfl.ui.GameInputDevice.get_numControls","openfl/ui/GameInputDevice.hx",108,0x744a6f4c)
...
HXLINE(  44)		 ::openfl::ui::GameInputControl control;
HXLINE(  46)		{
HXLINE(  46)			int _g = (int)0;
HXDLIN(  46)			while((_g < (int)6)){
HXLINE(  46)				_g = (_g + (int)1);
HXDLIN(  46)				int i = (_g - (int)1);
HXLINE(  48)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),(int)-1,(int)1,null());
HXLINE(  49)				this->_hx___axis->set(i,control);
HXLINE(  50)				this->_hx___controls->push(control);
            			}
            		}
HXLINE(  54)		{
HXLINE(  54)			int _g1 = (int)0;
HXDLIN(  54)			while((_g1 < (int)15)){
HXLINE(  54)				_g1 = (_g1 + (int)1);
HXDLIN(  54)				int i1 = (_g1 - (int)1);
HXLINE(  56)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),(int)0,(int)1,null());
HXLINE(  57)				this->_hx___button->set(i1,control);
...
bool append = __o_append.Default(false);
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_67_getCachedSamples)
...
HX_DEFINE_DYNAMIC_FUNC2(GameInputDevice_obj,getCachedSamples,return )
 ...
 ::openfl::ui::GameInputControl GameInputDevice_obj::getControlAt(int i){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_72_getControlAt)
HXLINE(  74)		bool _hx_tmp;
HXDLIN(  74)		if ((i >= (int)0)) {
HXLINE(  74)			_hx_tmp = (i < this->_hx___controls->length);
            		}
            		else {
HXLINE(  74)			_hx_tmp = false;
            		}
HXDLIN(  74)		if (_hx_tmp) {
HXLINE(  76)			return this->_hx___controls->__get(i).StaticCast<  ::openfl::ui::GameInputControl >();
            		}
...
void GameInputDevice_obj::startCachingSamples(int numSamples, ::openfl::_Vector::AbstractVector controls){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_85_startCachingSamples)
            	}
...
void GameInputDevice_obj::stopCachingSamples(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_92_stopCachingSamples)
            	}
...
int GameInputDevice_obj::get_numControls(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_108_get_numControls)
HXDLIN( 108)		return this->_hx___controls->length;
            	}
