...
HX_LOCAL_STACK_FRAME(_hx_pos_d04537844d94f90f_28___init__,"::openfl::ui::Multitouch_obj","__init__",0xd9e1825c,"::openfl::ui::Multitouch_obj.__init__","openfl/ui/Multitouch.hx",28,0xce42901c)
...
void Multitouch_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_d04537844d94f90f_28___init__)
HXLINE(  30)		::openfl::ui::Multitouch_obj::maxTouchPoints = (int)2;
HXLINE(  31)		::openfl::ui::Multitouch_obj::supportedGestures = null();
HXLINE(  32)		::openfl::ui::Multitouch_obj::supportsGestureEvents = false;
HXLINE(  33)		::openfl::ui::Multitouch_obj::inputMode = (int)2;
            	}
