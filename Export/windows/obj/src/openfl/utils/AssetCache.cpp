...
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_43_clear,"openfl.utils.AssetCache","clear",0x6abcde6c,"openfl.utils.AssetCache.clear","openfl/utils/AssetCache.hx",43,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_94_getBitmapData,"openfl.utils.AssetCache","getBitmapData",0x142af5ce,"openfl.utils.AssetCache.getBitmapData","openfl/utils/AssetCache.hx",94,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_101_getFont,"openfl.utils.AssetCache","getFont",0xa580b024,"openfl.utils.AssetCache.getFont","openfl/utils/AssetCache.hx",101,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_108_getSound,"openfl.utils.AssetCache","getSound",0xa75444da,"openfl.utils.AssetCache.getSound","openfl/utils/AssetCache.hx",108,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_115_hasBitmapData,"openfl.utils.AssetCache","hasBitmapData",0xd20f5192,"openfl.utils.AssetCache.hasBitmapData","openfl/utils/AssetCache.hx",115,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_122_hasFont,"openfl.utils.AssetCache","hasFont",0xa24220e8,"openfl.utils.AssetCache.hasFont","openfl/utils/AssetCache.hx",122,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_129_hasSound,"openfl.utils.AssetCache","hasSound",0xd3d57f96,"openfl.utils.AssetCache.hasSound","openfl/utils/AssetCache.hx",129,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_134_removeBitmapData,"openfl.utils.AssetCache","removeBitmapData",0x9ca8649e,"openfl.utils.AssetCache.removeBitmapData","openfl/utils/AssetCache.hx",134,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_142_removeFont,"openfl.utils.AssetCache","removeFont",0x136c22f4,"openfl.utils.AssetCache.removeFont","openfl/utils/AssetCache.hx",142,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_150_removeSound,"openfl.utils.AssetCache","removeSound",0x676d480a,"openfl.utils.AssetCache.removeSound","openfl/utils/AssetCache.hx",150,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_160_setBitmapData,"openfl.utils.AssetCache","setBitmapData",0x5930d7da,"openfl.utils.AssetCache.setBitmapData","openfl/utils/AssetCache.hx",160,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_167_setFont,"openfl.utils.AssetCache","setFont",0x98824130,"openfl.utils.AssetCache.setFont","openfl/utils/AssetCache.hx",167,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_174_setSound,"openfl.utils.AssetCache","setSound",0x55b19e4e,"openfl.utils.AssetCache.setSound","openfl/utils/AssetCache.hx",174,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_188_get_enabled,"openfl.utils.AssetCache","get_enabled",0xec9842b7,"openfl.utils.AssetCache.get_enabled","openfl/utils/AssetCache.hx",188,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_195_set_enabled,"openfl.utils.AssetCache","set_enabled",0xf70549c3,"openfl.utils.AssetCache.set_enabled","openfl/utils/AssetCache.hx",195,0xffd5b4cf)
namespace openfl{
namespace utils{
...
HXLINE(  34)		this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  35)		this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  36)		this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_GC_STACKFRAME(&_hx_pos_3b51c86a24135fbd_43_clear)
HXDLIN(  43)		if (hx::IsNull( prefix )) {
HXLINE(  45)			this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  46)			this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  47)			this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
            		else {
HXLINE(  51)			 ::Dynamic keys = this->bitmapData->keys();
HXLINE(  53)			{
HXLINE(  53)				 ::Dynamic key = keys;
HXDLIN(  53)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  53)					::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  55)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  57)						this->removeBitmapData(key1);
            					}
            				}
            			}
HXLINE(  63)			 ::Dynamic keys1 = this->font->keys();
HXLINE(  65)			{
HXLINE(  65)				 ::Dynamic key2 = keys1;
HXDLIN(  65)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  65)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  67)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE(  69)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE(  75)			 ::Dynamic keys2 = this->sound->keys();
HXLINE(  77)			{
HXLINE(  77)				 ::Dynamic key4 = keys2;
HXDLIN(  77)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  77)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  79)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE(  81)						this->removeSound(key5);
            					}
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,clear,(void))
 ...
 ::openfl::display::BitmapData AssetCache_obj::getBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_94_getBitmapData)
HXDLIN(  94)		return this->bitmapData->get(id).StaticCast<  ::openfl::display::BitmapData >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getBitmapData,return )
 ...
 ::openfl::text::Font AssetCache_obj::getFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_101_getFont)
HXDLIN( 101)		return this->font->get(id).StaticCast<  ::openfl::text::Font >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getFont,return )
 ...
 ::openfl::media::Sound AssetCache_obj::getSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_108_getSound)
HXDLIN( 108)		return this->sound->get(id).StaticCast<  ::openfl::media::Sound >();
            	}
...
bool AssetCache_obj::hasBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_115_hasBitmapData)
HXDLIN( 115)		return this->bitmapData->exists(id);
            	}
...
bool AssetCache_obj::hasFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_122_hasFont)
HXDLIN( 122)		return this->font->exists(id);
            	}
...
bool AssetCache_obj::hasSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_129_hasSound)
HXDLIN( 129)		return this->sound->exists(id);
            	}
...
bool AssetCache_obj::removeBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_134_removeBitmapData)
HXLINE( 136)		::lime::utils::Assets_obj::cache->image->remove(id);
HXLINE( 137)		return this->bitmapData->remove(id);
            	}
...
bool AssetCache_obj::removeFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_142_removeFont)
HXLINE( 144)		::lime::utils::Assets_obj::cache->font->remove(id);
HXLINE( 145)		return this->font->remove(id);
            	}
...
bool AssetCache_obj::removeSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_150_removeSound)
HXLINE( 152)		::lime::utils::Assets_obj::cache->audio->remove(id);
HXLINE( 153)		return this->sound->remove(id);
            	}
...
void AssetCache_obj::setBitmapData(::String id, ::openfl::display::BitmapData bitmapData){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_160_setBitmapData)
HXDLIN( 160)		this->bitmapData->set(id,bitmapData);
            	}
...
void AssetCache_obj::setFont(::String id, ::openfl::text::Font font){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_167_setFont)
HXDLIN( 167)		this->font->set(id,font);
            	}
...
void AssetCache_obj::setSound(::String id, ::openfl::media::Sound sound){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_174_setSound)
HXDLIN( 174)		this->sound->set(id,sound);
            	}
...
bool AssetCache_obj::get_enabled(){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_188_get_enabled)
HXDLIN( 188)		return this->_hx___enabled;
            	}
...
bool AssetCache_obj::set_enabled(bool value){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_195_set_enabled)
HXDLIN( 195)		return (this->_hx___enabled = value);
            	}
