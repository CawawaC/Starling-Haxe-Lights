...
HXLINE( 162)			data = hx::TCast<  ::openfl::display::Bitmap >::cast(data)->bitmapData;
            		}
...
HXDLIN( 301)		return ::starling::textures::Texture_obj::fromBitmapData(bitmap->bitmapData,generateMipMaps,optimizeForRenderToTexture,scale,format,forcePotTexture,async);
            	}
